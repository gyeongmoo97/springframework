...
<div class="card m-2">
	...
	<div class="card-body">
			...
			<tr>
				<td colspan="4" class="text-center">
					<div>
						...
						<!-- 그룹이 1인 경우에는 안보이게 함 -->
						<c:if test="${pager.groupNo>1}"><a class="btn btn-outline-info btn-sm" href="boardList?pageNo=${pager.startPageNo-1}">이전</a></c:if>
						...
						<a class="btn btn-outline-primary btn-sm" href="boardList?pageNo=${pager.totalPageNo}">맨 끝</a>
					</div>
				</td>
			</tr>
		...
		<div class="mt-2 ">
			<a href="boardWriteForm" class="btn btn-success btn-sm">새 글쓰기</a>
