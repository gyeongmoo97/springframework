...
<ul class="nav flex-column">
	<li class="nav-item mb-2">
		<h6 class="text-white">
			...
			<a class="text-white" href="${pageContext.request.contextPath}/ch01/content">프로젝트 생성 및 실행</a>
		</h6>
	</li>
	<li class="nav-item mb-2">
		<h6 class="text-white">
			<span class="mr-2">Ch02.</span>
			<a class="text-white" href="${pageContext.request.contextPath}/ch02/content">Controller/Request Mapping</a>
		</h6>
	</li>
	<li class="nav-item mb-2">
		<h6 class="text-white">
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			...
			<a class="text-white" href="${pageContext.request.contextPath}/ch04/content">Controller/Validation</a>
		</h6>
	</li>
	<li class="nav-item mb-2">
		<h6 class="text-white">
			<span class="mr-2">Ch05.</span>
			<a class="text-white" href="${pageContext.request.contextPath}/ch05/content">Controller/Header & Cookie</a>
		</h6>
	</li>
	<li class="nav-item mb-2">
		<h6 class="text-white">
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			...
			<a class="text-white" href="${pageContext.request.contextPath}/ch10/content">Controller/Exception Handling</a>
		</h6>
	</li>
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			...
			<a class="text-white" href="${pageContext.request.contextPath}/ch15/content">AOP(Aspect Oriented Programming)</a>
		</h6>
	</li>
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			...
			<a class="text-white" href="${pageContext.request.contextPath}/ch16/content">Transaction</a>
		</h6>
	</li>
	<li class="nav-item mb-2">
		<h6 class="text-white">
			<span class="mr-2">Ch17.</span>
			<a class="text-white" href="${pageContext.request.contextPath}/ch17/content">Spring Security</a>
		</h6>
	</li>
