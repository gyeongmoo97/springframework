...
//	private Ch13Service3 ch13Service3;
//	이렇게 하면 인터페이스 사용하지 않는것임
...
//	private Ch13Service5 ch13Service5;
	...
	public void setCh13Service1(Ch13Service1 ch13Service1) {
		logger.info("setCh13Service1(Ch13Service1 ch13Service1)실행");
	...
	public String request2() {
		...
		logger.info("실행");
		ch13Service2.method2();
		return "redirect:/ch13/content";
	}
	
	@GetMapping("/request3")
	public String request2_2() {
		
		logger.info("실행");
		ch13Service.method2_2();
		return "redirect:/ch13/content";
	}
